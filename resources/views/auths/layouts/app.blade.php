...
<html lang="en">
  <head>
    ...
    <title>RT/TWnet - @yield('title')</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{route('dashboard')}}" class="site_title"><span><center>RT/RWnet</center></span></a>
            </div>
            ...
            <div style="text-align: center; padding-right: 20px;">
              <img src="{{ asset('dashboard/images/logo.png') }}" style="width: 50px; height: 45px;" alt="..." class="img-circle profile_img">
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li>
                    <a href="{{route('customers')}}"><i class="fa fa-users"></i> Pelanggan Bulanan</a>
                  </li>
                  <li>
                    <a href="{{route('hotspot')}}"><i class="fa fa-users"></i> Agen Hotspot</a>
                  </li>
            ...
            <div class="sidebar-footer hidden-small">
              <a data-toggle="tooltip" data-placement="top" href="{{route('users')}}" title="Pengaturan">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('dashboard/images/logo.png') }}" alt="">Administrator
                  </a>
