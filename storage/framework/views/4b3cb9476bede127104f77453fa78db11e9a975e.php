...
<html lang="en">
  <head>
    ...
    <title>RT/TWnet - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo e(route('dashboard')); ?>" class="site_title"><span><center>RT/RWnet</center></span></a>
            </div>
            ...
            <div style="text-align: center; padding-right: 20px;">
              <img src="<?php echo e(asset('dashboard/images/logo.png')); ?>" style="width: 50px; height: 45px;" alt="..." class="img-circle profile_img">
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-gear"></i> Pengaturan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo e(route('users')); ?>">Administrator</a></li>
                      <li><a href="<?php echo e(route('packet')); ?>">Packet Berlangganan</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="<?php echo e(route('customers')); ?>"><i class="fa fa-users"></i> Pelanggan Bulanan</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('hotspot')); ?>"><i class="fa fa-users"></i> Agen Hotspot</a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Pelaporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Berlangganan</a></li>
                      <li><a href="#">Stock Agen Hotspot</a></li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e(asset('dashboard/images/logo.png')); ?>" alt="">Administrator
                  </a>
...
<?php /**PATH C:\xampp\htdocs\best-net\resources\views/auths/layouts/app.blade.php ENDPATH**/ ?>